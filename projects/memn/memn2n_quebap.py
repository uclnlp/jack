...
tf.flags.DEFINE_string("train_file", "../../data/SQuAD/snippet.jtr.json", "Training file containing QA dataset. Required annotation: questions with answer spans and supporting text.")
tf.flags.DEFINE_string("test_file", "../../data/SQuAD/snippet.jtr.json", "Test file containing QA dataset. Required annotation: questions with answer spans and supporting text.")
tf.flags.DEFINE_string("dev_file", "../../data/SQuAD/snippet.jtr.json", "Dev file containing QA dataset. Required annotation: questions with answer spans and supporting text.")
