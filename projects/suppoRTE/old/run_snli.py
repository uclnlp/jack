...
from jtr.projects.suppoRTE.snli_trainer import train
...
tf.app.flags.DEFINE_string('data', './jtr/data/SNLI/snli_1.0/', 'data dir of SNLI.')
tf.app.flags.DEFINE_string('embedding_format', 'pkl', 'pkl|glove|word2vec_bin|word2vec')
tf.app.flags.DEFINE_string('embedding_file', './jtr/data/GloVe/glove.6B.50d.pkl', 'path to embeddings file')
...
tf.app.flags.DEFINE_string('model_path', './jtr/projects/suppoRTE/save/', 'only evaluation')
