...
def main():
    ...
    if len(sys.argv) == 2:
        ...
        with open("./quebap/data/SNLI/snli_1.0/snli_1.0_debug_quebap_v2.jsonl", 'w') as outfile:
            json.dump(corpus, outfile, indent=2)
        with open("./quebap/data/snippet/SNLI_v1/snippet_quebapformat_v2.json", 'w') as outfile:
            json.dump(corpus, outfile, indent=2)
