# ADAPTED FROM https://github.com/pbhatia243/Neural_Conversation_Models
...
def rnn_decoder(decoder_inputs, initial_state, cell, output_projection=None, loop_function=None,
                scope=None):
...
def embedding_rnn_decoder(decoder_inputs, initial_state, cell, num_symbols,
    ...
    with variable_scope.variable_scope(scope or "embedding_rnn_decoder"):
        ...
        if beam_search:
            ...
            return rnn_decoder(emb_inp, initial_state, cell, output_projection=output_projection,
...
def attention_decoder(decoder_inputs, initial_state, attention_states, cell,
                      ...
                      dtype=dtypes.float32, scope=None, output_projection=None,
