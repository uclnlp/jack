import re
from quebap.projects.inferbeddings.lang import *
import quebap.projects.inferbeddings.engine as engine
import tensorflow as tf

dl = engine.LowRankLog(150, 60, emb_dim=10, reg_pred=0.1, emb_std_dev=1.0,
                       linear_squash=False, trainer=tf.train.AdamOptimizer(learning_rate=0.001))
