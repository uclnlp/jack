...
def convert_newsqa(file_path):
    """
    Converts NewsQA dataset to jtr format.
...
def main():
    ...
    Returns: nothing
    """
    parser = argparse.ArgumentParser(description='NewsQA dataset to jtr format converter.')
    parser.add_argument('infile',
                        help="path to the input file, original NewsQA file (e.g. data/NewsQA/newsqa/maluuba/newsqa/split_data/train.csv)")
    parser.add_argument('outfile',
                        help="path to the jtr format -generated output file (e.g. data/NewsQA/train.jtr.json)")
