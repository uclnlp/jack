...
def convert_cbt(path, n_instances=None):
    """
    Convert the Children's Book Test file into jtr format.
...
def main():
    ...
    parser = argparse.ArgumentParser(description='The Children’s Book Test (CBT) dataset to jtr format converter.')
    parser.add_argument('infile',
                        help="path to the file to be converted (e.g. data/CBT/CBTest/data/cbtest_CN_train.txt)")
    parser.add_argument('outfile',
                        help="path to the jtr format -generated output file (e.g. data/CBT/train.jtr.json)")
