...
def convert_babi(path, n_instances=None):
    """
    Convert the babi data into jtr format.
...
def main():
    ...
    parser = argparse.ArgumentParser(description='The bAbI dataset to jtr format converter.')
    parser.add_argument('infile',
                        help="path to the file to be converted (e.g. data/bAbI/tasks_1-20_v1-2/en/qa2_two-supporting-facts_train.txt)")
    parser.add_argument('outfile',
                        help="path to the jtr format -generated output file (e.g. data/bAbI/jtr_format/train.jtr.json)")
