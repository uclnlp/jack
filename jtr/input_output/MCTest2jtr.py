...
def main():
    parser = argparse.ArgumentParser(description='Machine Comprehension Test (MCTest) dataset to jtr format converter.')
    ...
    parser.add_argument('outfile',
                        help="path to the jtr format -generated output file (e.g. data/MCTest/train.160.jtr.json)")
