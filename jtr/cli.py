...
def get_config():
    ...
    parser.add_argument('--train', default=None, type=argparse.FileType('r'), help="jtr training file")
    parser.add_argument('--dev', default=None, type=argparse.FileType('r'), help="jtr dev file")
    parser.add_argument('--test', default=None, type=argparse.FileType('r'), help="jtr test file")
    parser.add_argument('--out', default=None, type=argparse.FileType('r'), help="jtr output file")
