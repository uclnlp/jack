...
from jack.util.util import get_data_path, load_hdf_file, Timer
from jack.util.global_config import Config
from jack.util.hdf5_processing.interfaces import IAtIterEndObservable, IAtEpochEndObservable, IAtEpochStartObservable, IAtBatchPreparedObservable
...
class StreamBatcher(object):
    def __init__(self, pipeline_name, name, batch_size, loader_threads=1, randomize=False, seed=None):
